...
export class RegisterForRaceComponent implements OnInit {
  ...
  registerForRunEvent(){
    ...
    console.log('saved!!!', this.raceRegistration);
    this.runEventsService.registerForRunEvent(this.raceRegistration);
    /*let link = ['races/'];
  ...
  prepareRegistrationDTO(){
    this.raceRegistration.raceId = this.sportEvent.id;
    this.raceRegistration.raceName = this.sportEvent.name;
    this.raceRegistration.raceOrganizator = this.sportEvent.organizer;
    this.raceRegistration.raceLocalization = this.sportEvent.localization;
    this.raceRegistration.raceDate = this.sportEvent.date;
    this.raceRegistration.raceDistance = this.sportEvent.distance;
  }
}
